...
namespace Producer
{
    public partial class Form1 : Form
    {
       ...
       private  IConnection connection;
        ...
        {
            channel.QueueDeclare(txtDeclareQueueName.Text,false,true,false);
        ...
        {
            channel.QueueBind(txtDeclareQueueName.Text,txtDeclareExchangeName.Text, txtDeclareQueueRoutingKey.Text);//txtRoutingKey.Text
        }
